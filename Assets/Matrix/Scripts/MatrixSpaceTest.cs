...
public class MatrixSpaceTest : MonoBehaviour {
    ...
    private void OnEnable() {
        ...
        var tm = CustomMatrixUtil.GetWorldMatrix(parent);
        var om = CustomMatrixUtil.GetObjectMatrix(parent);
        var vm = CustomMatrixUtil.GetViewMatrix(cam);
        var pm = CustomMatrixUtil.GetProjectionMatrix(cam);
        ...
        var testScreenPos = CustomMatrixUtil.GetScreenPos(cam, testClipPos);
